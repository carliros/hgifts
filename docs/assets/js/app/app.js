...
(function($PS) {
  ...
  var app = function (dictMonadEffect) {
      var render = function (v) {
          ...
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "prose m-2 sm:m-4 md:m-8 lg:m-16 xl:m-32", "p-6", "flex-column", "justify-center", "items-center", "h-screen" ]) ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Test de dones espirituales") ]), bodyContent, Halogen_HTML_Elements.br_, Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ "btn-green" ]), Halogen_HTML_Events.onClick(function (v1) {
