...
(function($PS) {
  ...
  var intro = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Querido hermano(a):") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Esta herramienta[1] es para examinar qu\xe9 dones tenemos, o podemos desarrollar o cu\xe1les dones no tenemos. Consiste de 66 preguntas que recaban informaci\xf3n sobre nuestras capacidades, habilidades, gustos, etc. por medio de expresiones o afirmaciones que nos permiten evaluarlas de acuerdo a nuestras vidas.") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("En cada pregunta debes responder el grado de verdad que cada frase tiene para usted seleccionando una de las opciones siguientes:") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("1. MUY POCO\x0a2. POCO\x0a3. REGULAR\x0a4. MUCHO\x0a5. MUCH\xcdSIMO") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Una vez que finalice la encuesta, los resultados ser\xe1n procesados y se dar\xe1n a conocer los resultados posteriormente al finalizar la reuni\xf3n.") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Por favor, presione continuar para realizar la encuesta.") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("[1]: Este cuestionario fue recabado de la secci\xf3n de recursos de la Iglesia Metodista Libre (https://iml-latinoamerica.org/materialpic/). Es utilizado sin permiso y solamente para prop\xf3sitos de conocer los dones espirituales de los participantes del Programa de Discipulado \"Ahora que Soy Miembro\" de la Iglesia Evang\xe9lica Bautista \"Nueva Vida\". ") ]) ]);
      };
      var initialState = function (intro1) {
          return intro1;
      };
      ...
      return Halogen_Component.mkComponent({
          ...
          "eval": Halogen_Component.mkEval({
              ...
              receive: function ($11) {
                  return Data_Maybe.Just.create(Receive.create($11));
              },
  ...
  var _intro = Type_Proxy["Proxy"].value;
  exports["_intro"] = _intro;
  exports["intro"] = intro;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var SelectedOption = (function () {
      function SelectedOption(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SelectedOption.create = function (value0) {
          return function (value1) {
              return new SelectedOption(value0, value1);
          };
      };
  ...
  var SelectOption = (function () {
      function SelectOption(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SelectOption.create = function (value0) {
          return function (value1) {
              return new SelectOption(value0, value1);
          };
      };
      return SelectOption;
  })();
  var question = function (dictMonadEffect) {
      ...
      var handleAction = function (v) {
          ...
          if (v instanceof SelectOption) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.logShow(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Data_Show.showString)("click " + Data_Show.show(Data_Show.showInt)(v.value1)))(function () {
  ...
  var _question = Type_Proxy["Proxy"].value;
  exports["_question"] = _question;
...
(function($PS) {
  ...
  var results = (function () {
      var initialState = function (intro) {
          return intro;
      };
      var handleAction = function (v) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
      ...
      var convert2Gift = function (i) {
          return function (list) {
              var array = Data_Array_NonEmpty.toArray(list);
              var gift = (function () {
                  var v = Data_Array.head(array);
                  if (v instanceof Data_Maybe.Just) {
                      return v.value0.gift;
                  };
                  if (v instanceof Data_Maybe.Nothing) {
                      return "";
                  };
                  throw new Error("Failed pattern match at Results (line 49, column 38 - line 51, column 54): " + [ v.constructor.name ]);
              })();
              var amount = Data_Array.foldr(function (qq) {
                  return function (acc) {
                      return Data_Maybe.fromMaybe(0)(qq.answer) + acc | 0;
                  };
              })(0)(array);
              return {
                  amount: amount,
      ...
      var compareQuestions = function (q1) {
          return function (q2) {
              return Data_Ord.compare(Data_Ord.ordString)(q1.gift)(q2.gift);
          };
      };
      var render = function (v) {
          var groups = Data_Array.groupAllBy(compareQuestions)(v.questions);
          var gifts = Data_Array.mapWithIndex(convert2Gift)(groups);
          var sorted = Data_Array.sortWith(Data_Ord.ordInt)(function (v1) {
              return v1.amount;
          })(gifts);
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Resultados") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showArray(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "amount";
          }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "gift";
          }))(Data_Show.showRecordFieldsNil)(Data_Show.showString))(Data_Show.showInt))))(sorted)) ]) ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
  ...
  var _results = Type_Proxy["Proxy"].value;
...
(function($PS) {
  ...
  var HandleSelectedOption = (function () {
      function HandleSelectedOption(value0) {
          this.value0 = value0;
      };
      HandleSelectedOption.create = function (value0) {
          return new HandleSelectedOption(value0);
      };
  ...
  var questions = [ {
      number: 1,
      gift: "administrar a",
      answer: Data_Maybe.Nothing.value,
      question: "Soy capaz de organizar ideas tareas personas y tiempo para el servicio cristiano."
  }, {
      number: 2,
      gift: "animar a",
      answer: Data_Maybe.Nothing.value,
      question: "El Esp\xedritu Santo me ha ayudado a animar a la gente a vivir una verdadera vida cristiana."
  }, {
      number: 3,
      gift: "evangelizar a",
      answer: Data_Maybe.Nothing.value,
      question: "Me gusta hablar de Jes\xfas a los que no le conocen."
  }, {
      number: 4,
      gift: "hospedar a",
      answer: Data_Maybe.Nothing.value,
      question: "Me da gusto proveer alojamiento y no me siento molesto por hu\xe9spedes inesperados."
  }, {
      number: 5,
      gift: "interceder a",
      answer: Data_Maybe.Nothing.value,
      question: "Tomo seriamente las peticiones de oraci\xf3n de otros y sigo orando por ellos."
  }, {
      number: 6,
      gift: "guiar a",
      answer: Data_Maybe.Nothing.value,
      question: "Puedo motivar a grupos a alcanzar objetivos b\xedblicos espec\xedficos."
  }, {
      number: 7,
      gift: "misericordia a",
      answer: Data_Maybe.Nothing.value,
      question: "Tengo la habilidad de mostrar compasi\xf3n por medio de hechos que realizo con amor y bondad."
  }, {
      number: 8,
      gift: "predicar a",
      answer: Data_Maybe.Nothing.value,
      question: "He rogado que la obra de Dios prospere tanto en la iglesia como en el mundo."
  }, {
      number: 9,
      gift: "servir a",
      answer: Data_Maybe.Nothing.value,
      question: "Me gusta hacer cosas que ayuden a otros a servir efectivamente."
  }, {
      number: 10,
      gift: "pastorear a",
      answer: Data_Maybe.Nothing.value,
      question: "He tenido la responsabilidad de animar a otros creyentes en su vida espiritual con buenos resultados."
  }, {
      number: 11,
      gift: "ense\xf1ar a",
      answer: Data_Maybe.Nothing.value,
      question: "Entienden bien la lecci\xf3n los alumnos (sean adultos o ni\xf1os) cuando yo la ense\xf1o."
  }, {
      number: 12,
      gift: "administrar b",
      answer: Data_Maybe.Nothing.value,
      question: "Me gusta planear actividades en las cuales otras personas est\xe1n involucradas."
  }, {
      number: 13,
      gift: "animar b",
      answer: Data_Maybe.Nothing.value,
      question: "Soy sensible a las personas que sufren y que tienen problemas; me gusta ayudarles a ver las respuestas de Dios a los problemas de la vida."
  }, {
      number: 14,
      gift: "evangelizar b",
      answer: Data_Maybe.Nothing.value,
      question: "Me gustar\xeda poder compartir el evangelio libre y eficazmente con personas no creyentes."
  }, {
      number: 15,
      gift: "hospedar b",
      answer: Data_Maybe.Nothing.value,
      question: "Soy sensible a los actos de amabilidad que hacen sentir bien a hu\xe9spedes y a extranjeros."
  }, {
      number: 16,
      gift: "interceder b",
      answer: Data_Maybe.Nothing.value,
      question: "Soy sensible a las peticiones de otros y procuro apoyarlos en oraci\xf3n."
  }, {
      number: 17,
      gift: "guiar b",
      answer: Data_Maybe.Nothing.value,
      question: "Tengo el deseo de ayudar dirigir y guiar a personas que desean tener un ministerio importante en la iglesia."
  }, {
      number: 18,
      gift: "misericordia b",
      answer: Data_Maybe.Nothing.value,
      question: "Me gustar\xeda ayudar a los que tienen debilidades mentales y f\xedsicas."
  }, {
      number: 19,
      gift: "predicar b",
      answer: Data_Maybe.Nothing.value,
      question: "Tengo un discernimiento espiritual de las Escrituras y s\xe9 relacionarlas a personas o cosa. Me gusta compartir o ense\xf1ar la Palabra de Dios."
  }, {
      number: 20,
      gift: "servir b",
      answer: Data_Maybe.Nothing.value,
      question: "Soy sensible a las necesidades de otros y estoy dispuesto a darles ayuda."
  }, {
      number: 21,
      gift: "pastorear b",
      answer: Data_Maybe.Nothing.value,
      question: "Estoy preocupado por ver si se llenan las necesidades espirituales de los creyentes. Estoy dispuesto a colaborar en tareas de discipulado y ministerio."
  }, {
      number: 22,
      gift: "ense\xf1ar b",
      answer: Data_Maybe.Nothing.value,
      question: "Me gusta ayudar a la gente a entender las cosas de Dios."
  }, {
      number: 23,
      gift: "administrar a",
      answer: Data_Maybe.Nothing.value,
      question: "Soy capaz de hacer planes eficaces para alcanzar metas."
  }, {
      number: 24,
      gift: "animar a",
      answer: Data_Maybe.Nothing.value,
      question: "He animando a la gente de la comunidad cristiana a amar y hacer buenas obras."
  }, {
      number: 25,
      gift: "evangelizar a",
      answer: Data_Maybe.Nothing.value,
      question: "Dios me ha usado para guiar a otros a creer en Cristo como su Salvador."
  }, {
      number: 26,
      gift: "hospedar a",
      answer: Data_Maybe.Nothing.value,
      question: "Tengo la habilidad de ayudar a extranjeros a sentirse como en casa tanto en mi propio hogar como en la iglesia."
  }, {
      number: 27,
      gift: "interceder a",
      answer: Data_Maybe.Nothing.value,
      question: "Oro por otros porque reconozco que la eficacia de su ministerio depende de mis oraciones."
  }, {
      number: 28,
      gift: "guiar a",
      answer: Data_Maybe.Nothing.value,
      question: "Me gusta ayudar a otros a alcanzar sus metas y guiarlos para que crezcan espiritualmente."
  }, {
      number: 29,
      gift: "misericordia a",
      answer: Data_Maybe.Nothing.value,
      question: "Me gusta trabajar con personas que sufren de problemas f\xedsicos mentales o emocionales."
  }, {
      number: 30,
      gift: "predicar a",
      answer: Data_Maybe.Nothing.value,
      question: "He proclamado mensajes urgentes y pr\xe1cticos de la Palabra de Dios."
  }, {
      number: 31,
      gift: "servir a",
      answer: Data_Maybe.Nothing.value,
      question: "Me gusta trabajar en cosas peque\xf1as para ayudar al desarrollo del cuerpo de Cristo."
  }, {
      number: 32,
      gift: "pastorear a",
      answer: Data_Maybe.Nothing.value,
      question: "Cuando veo una persona descarriada me siento responsable por su bienestar."
  }, {
      number: 33,
      gift: "ense\xf1ar a",
      answer: Data_Maybe.Nothing.value,
      question: "Puedo ense\xf1ar de una manera sencilla para que tanto los ni\xf1os como los adultos entiendan la lecci\xf3n."
  }, {
      number: 34,
      gift: "administrar b",
      answer: Data_Maybe.Nothing.value,
      question: "Me gustar\xeda supervisar un programa o ministerio en la iglesia."
  }, {
      number: 35,
      gift: "animar b",
      answer: Data_Maybe.Nothing.value,
      question: "Yo creo que las personas llegar\xe1n a la madurez espiritual por medio del consejo e instrucci\xf3n de la Palabra."
  }, {
      number: 36,
      gift: "evangelizar b",
      answer: Data_Maybe.Nothing.value,
      question: "Siento una carga por amigos y conocidos que no creen en Cristo."
  }, {
      number: 37,
      gift: "hospedar b",
      answer: Data_Maybe.Nothing.value,
      question: "Soy m\xe1s atento a las necesidades de otros que a las m\xedas."
  }, {
      number: 38,
      gift: "interceder b",
      answer: Data_Maybe.Nothing.value,
      question: "Tengo la convicci\xf3n de que Dios obra en respuesta a las oraciones y quiero ser usado para ayudar a otros por medio de mis oraciones."
  }, {
      number: 39,
      gift: "guiar b",
      answer: Data_Maybe.Nothing.value,
      question: "Si tuviera la oportunidad me gustar\xeda guiardirigir y motivar a otros en alg\xfan aspecto de la obra de Dios."
  }, {
      number: 40,
      gift: "misericordia b",
      answer: Data_Maybe.Nothing.value,
      question: "Cuando miro la miseria humana no me repugna sino m\xe1s bien me estimula a encontrar la manera de expresar el amor de Dios a los que sufren."
  }, {
      number: 41,
      gift: "predicar b",
      answer: Data_Maybe.Nothing.value,
      question: "Si tuviera oportunidad me gustar\xeda ser un predicador de la Palabra de Dios."
  }, {
      number: 42,
      gift: "servir b",
      answer: Data_Maybe.Nothing.value,
      question: "Me gusta por naturaleza hacer trabajos que ayudan a otros a realizar efectivamente sus propias tareas."
  }, {
      number: 43,
      gift: "pastorear b",
      answer: Data_Maybe.Nothing.value,
      question: "Siento en m\xed una inquietud pastoral cuando me entero de cristianos que necesitan consejo espiritual."
  }, {
      number: 44,
      gift: "ense\xf1ar b",
      answer: Data_Maybe.Nothing.value,
      question: "Reconozco en seguida cuando alguien (ni\xf1o o adulto) no ha entendido claramente la lecci\xf3n."
  }, {
      number: 45,
      gift: "administrar a",
      answer: Data_Maybe.Nothing.value,
      question: "Poseo el sentido de delegar tareas importantes a las personas indicadas en el tiempo oportuno."
  }, {
      number: 46,
      gift: "animar a",
      answer: Data_Maybe.Nothing.value,
      question: "Estoy feliz cuando las personas que necesitan consuelo consolaci\xf3n \xe1nimo y consejo vienen a buscarme a m\xed."
  }, {
      number: 47,
      gift: "evangelizar a",
      answer: Data_Maybe.Nothing.value,
      question: "Soy capaz de compartir el evangelio de tal manera que sea claro y significativo para personas no creyentes."
  }, {
      number: 48,
      gift: "hospedar a",
      answer: Data_Maybe.Nothing.value,
      question: "Mi casa siempre est\xe1 disponible para los que necesitan hospedaje."
  }, {
      number: 49,
      gift: "interceder a",
      answer: Data_Maybe.Nothing.value,
      question: "Soy consciente de ministrar a otros mientras oro por ellos."
  }, {
      number: 50,
      gift: "guiar a",
      answer: Data_Maybe.Nothing.value,
      question: "He aceptado las responsabilidades de un l\xedder y he tenido \xe9xito en guiar al grupo hacia su meta."
  }, {
      number: 51,
      gift: "misericordia a",
      answer: Data_Maybe.Nothing.value,
      question: "Las visitas que hago son de ayuda espiritual a los enfermos inv\xe1lidos y reclusos."
  }, {
      number: 52,
      gift: "predicar a",
      answer: Data_Maybe.Nothing.value,
      question: "Dios me ha usado para desarrollar animar y fortalecer a otros creyentes habl\xe1ndoles de la Biblia."
  }, {
      number: 53,
      gift: "servir a",
      answer: Data_Maybe.Nothing.value,
      question: "Encuentro frecuentemente maneras pr\xe1cticas de ayudar a otros y recibo satisfacci\xf3n al hacerlo."
  }, {
      number: 54,
      gift: "pastorear a",
      answer: Data_Maybe.Nothing.value,
      question: "El Se\xf1or me ha usado para cuidar guiar e instruir a otros creyentes hacia la madurez espiritual."
  }, {
      number: 55,
      gift: "ense\xf1ar a",
      answer: Data_Maybe.Nothing.value,
      question: "Puedo captar la atenci\xf3n y el inter\xe9s de la gente a quien ense\xf1o."
  }, {
      number: 56,
      gift: "administrar b",
      answer: Data_Maybe.Nothing.value,
      question: "Soy capaz de saber c\xf3mo y cu\xe1ndo los proyectos y trabajos deben estar mejor organizados."
  }, {
      number: 57,
      gift: "animar b",
      answer: Data_Maybe.Nothing.value,
      question: "Estoy dispuesto a dedicar tiempo cada semana para aconsejar a otros."
  }, {
      number: 58,
      gift: "evangelizar b",
      answer: Data_Maybe.Nothing.value,
      question: "Puedo sentir cuando una persona no conoce a Cristo y eso me da dolor."
  }, {
      number: 59,
      gift: "hospedar b",
      answer: Data_Maybe.Nothing.value,
      question: "Tengo un aprecio genuino para cada hu\xe9sped en mi casa."
  }, {
      number: 60,
      gift: "interceder b",
      answer: Data_Maybe.Nothing.value,
      question: "Puedo sentir r\xe1pidamente cuando un grupo del cual soy miembro est\xe1 perdiendo el tiempo y quiero hacer algo para cambiarlo."
  }, {
      number: 61,
      gift: "guiar b",
      answer: Data_Maybe.Nothing.value,
      question: "Me sentir\xeda gozoso si alguien me pidiera ser su compa\xf1ero de oraci\xf3n para su ministerio."
  }, {
      number: 62,
      gift: "misericordia b",
      answer: Data_Maybe.Nothing.value,
      question: "Tengo la habilidad de saber cuando las personas sufren de una manera u otra."
  }, {
      number: 63,
      gift: "predicar b",
      answer: Data_Maybe.Nothing.value,
      question: "Creo que m\xe1s creyentes deben involucrarse en discusiones y acciones sobre a la moral como el aborto el libertinaje sexual el racismo etc."
  }, {
      number: 64,
      gift: "servir b",
      answer: Data_Maybe.Nothing.value,
      question: "Me gustar\xeda tener m\xe1s oportunidad de ayudar a otros en sus ministerios."
  }, {
      number: 65,
      gift: "pastorear b",
      answer: Data_Maybe.Nothing.value,
      question: "Me gustar\xeda poder capacitar a los creyentes para la obra en el ministerio."
  }, {
      number: 66,
      gift: "ense\xf1ar b",
      answer: Data_Maybe.Nothing.value,
      question: "Me emociona aumentar mis conocimientos de la Palabra de Dios."
  } ];
  var app = function (dictMonadEffect) {
      var render = function (v) {
          var bodyContent = (function () {
              ...
              var $14 = v.page >= 1 && v.page <= Data_Array.length(v.questions);
              if ($14) {
          ...
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h2([  ])([ Halogen_HTML_Core.text("Test de dones espirituales") ]), bodyContent, Halogen_HTML_Elements.br_, Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v1) {
      ...
      var handleAction = function (v) {
          ...
          if (v instanceof HandleSelectedOption) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var newQuestions = Data_Array.mapWithIndex(function (v1) {
                      return function (q) {
                          var $27 = v.value0.value0 === q.number;
                          if ($27) {
                              var $28 = {};
                              for (var $29 in q) {
                                  if ({}.hasOwnProperty.call(q, $29)) {
                                      $28[$29] = q[$29];
                                  };
                              };
                              $28.answer = new Data_Maybe.Just(v.value0.value1);
                              return $28;
                          };
                          return q;
                      };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(App.app(Effect_Aff.monadEffectAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();